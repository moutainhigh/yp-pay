...
public interface ProfitShareRecordMapper extends Mapper<ProfitShareRecordDO>{
     ...
     * @return
     */
    List<ProfitShareRecordDO> selectRecodeByOrderNo(@Param(value = "orderNo") String merchantOrderNo);
     ...
     * @return
     */
    List<ProfitShareRecordDO> selectRecodeByPlatOrderNo(@Param(value = "platOrderNo") String platOrderNo);
     ...
     * @return
     */
    List<ProfitShareRecordDO> selectRecodeByChannelOrderNo(@Param(value = "channelOrderNo") String channelOrderNo);
     ...
     * @return
     */
    ProfitShareRecordDO selectRecodeByProfitShareNo(@Param(value = "profitShareNo") String profitShareNo);
     ...
     * @return
     */
    ProfitShareRecordDO selectRecodeByPlatProfitShareNo(@Param(value = "platProfitShareNo") String platProfitShareNo);
